...
Use `BACKLOG.md` §0 as the active next-work list: pick static missing routes before optional PDP/LMS polish. Do not expand shell CSS without a functional gap.
